  ...
  <link rel="stylesheet" href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.min.css">
	...
	$(document).ready(function() {
		$("#button").click(function() {
			...
			$.ajax({
				url: 'questQuery.php',
				data: {param: $( "#searchQuest" ).val(), gt: $( "#gt" ).prop("checked"), lt: $( "#lt" ).prop("checked"), sb: $( "#sb" ).val() },
...
<div class="container">
  <h3 style="position: relative; left: -15px; padding-left: 10px;">Search Quests</h3>
		<div class="row">
	       ...
	       <input class="form-control" style="width: 20%; margin-bottom: 5px;" id="searchQuest" type="search" size="30" placeholder="Quest"/>
  ...
  <h4 style="position: relative; left: 25px;">Quest Search Result</h4>
